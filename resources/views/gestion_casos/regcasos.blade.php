                        ...
                        <div class="col-xs-12 col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('fecha') ? ' has-error' : '' }}">
                                        <label for="fecha" class="col-md-3 control-label">Fecha del Caso</label>
                                            ...
                                            <button type="button" id="hoy" class="btn-xs btn-primary">Fecha hoy</button>
                                                @if ($errors->has('fecha'))
                            ...
                            <div class="col-xs-12 col-md-6">
                                        ...
                                        <div class="col-md-5">
                                        <input type="text" class="form-control" name="parroquia" placeholder="Parroquia" value="{{old('parroquia')}}">
                                        ...
                                        <div class="form-group{{ $errors->has('nro_personas') ? ' has-error' : '' }}">
                                          ...
                                          <div class="col-md-3">
                                            <input type="number" class="form-control" name="nro_personas" placeholder="Afectadas" value="{{old('nro_personas')}}">
                                          ...
                                          <div class="col-md-3">
                                          <input type="number" class="form-control" name="nro_heridos" placeholder="Heridos" value="{{old('nro_heridos')}}">
                                          ...
                                          @endif
                                            ...
                                            <div class="col-md-3">
                                            <input type="number" class="form-control" name="nro_decesos" placeholder="Decesos" value="{{old('nro_decesos')}}">
